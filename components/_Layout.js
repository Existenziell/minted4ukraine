...
const Layout = ({ children }) => {
  return (
    <>
      ...
      <div className='flex items-center justify-between bg-ukraine-blue text-ukraine-yellow p-4'>
      ...
      <main className='w-full min-h-screen py-8 px-4 md:px-8 text-center text-ukraine-yellow bg-ukraine-blue bg-cover'>
        {children}
      </main>
    </>
  )
